...
public class SecurityUtil {
     ...
     */
    public static Manager login(Integer ID, String password, AuthenticationManager authenticationManager) throws AuthenticationException {
     ...
     * @return
     */
    public static Manager getManagerInfo() {
